        ...
        <div class="card">
            <div class="card-body">
                <div class="row d-flex justify-content-between lh-sm">
                    Google Two-Factor Authentication enhances security by confirming a user's identity with two different factors. It safeguards against phishing, social engineering, and password attacks. Enable it by scanning the barcode or using the Google Secret Key. Remember to backup the Secret Key for added security.
                </div>
            </div>
        </div>
