...
class Google2FaController extends Controller
{
    ...
    public function activation(validatorGoogle2fa $request)
    {
        try {
            ...
            if ($result === true) {
                $notification = [
                    'message'     => 'Code Match, Successfuly activation of Google 2FA.',
                    'alert-type'  => 'success',
                    'gravity'     => 'bottom',
                    'position'    => 'right'
                ];
            ...
            $notification = [
                'message'     => 'An error occurred on the internal server.',
                'alert-type'  => 'danger',
                'gravity'     => 'bottom',
                'position'    => 'right'
            ];
    ...
    public function google2FaValidator(validatorGoogle2fa $request)
    {
        ...
        if ($valid) {
            ...
            $notification = [
                'message'     => 'Welcome to the CMS AfyaPacs.',
                'alert-type'  => 'success',
                'gravity'     => 'bottom',
                'position'    => 'right'
            ];
            ...
            $notification = [
                'message'     => 'Code No match, OTP Google 2FA Failed.',
                'alert-type'  => 'danger',
                'gravity'     => 'bottom',
                'position'    => 'right'
            ];
